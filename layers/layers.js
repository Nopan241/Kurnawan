...
var lyr_Sebaran_Penginapan_4 = new ol.layer.Vector({
                ...
                interactive: true,
                title: '<img src="styles/legend/Sebaran_Penginapan_4.png" /> Sebaran_Penginapan'
            });
...
lyr_Sebaran_Penginapan_4.set('fieldLabels', {'X': 'no label', 'Y': 'no label', 'Nama_Pengi': 'header label - always visible', 'Alamat': 'header label - always visible', 'Kelurahan': 'header label - always visible', 'Kecamatan': 'header label - always visible', 'Kota': 'header label - always visible', 'Provinsi': 'header label - always visible', 'Kode_Pos': 'header label - always visible', 'Harga_Perm': 'header label - always visible', 'Bintang': 'header label - always visible', 'Fasilitas': 'header label - always visible', 'Rating_Gma': 'header label - always visible', 'Keterangan': 'header label - always visible', });
